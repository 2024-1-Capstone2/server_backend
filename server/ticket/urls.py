...
urlpatterns = [
    ...
    path('api/small-region', rest_views.request_select_small_region, name='request_select_small_region'),
    path('api/bus-stop', rest_views.request_select_bus_stop, name='request_select_bus_stop'),
    ...
    path('small-region', ssr_views.select_small_region, name='select_small_region'),
    path('bus-stop', ssr_views.select_bus_stop, name='select_bus_stop'),
